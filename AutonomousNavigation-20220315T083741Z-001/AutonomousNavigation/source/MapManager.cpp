...
static const double  MIN_THRESHOLD = 0.1;
static const double  MAX_THRESHOLD = 4.0;
static const double  MIN_AREA      = 15;
...
MapManager::MapManager(int hsize, double resolution, RobotGeometry const & rg, PosedMap const & globalmap):
  rg(rg), hsize(hsize), init(false), resolution(resolution), origin({0.,0}), global_map(globalmap)
{}
